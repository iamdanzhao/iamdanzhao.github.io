...
- **The potential for algorithmic bias in Sidewalk Labs' smart city**, how that bias would harm vulnerable populations, and how algorithmic oversight boards can help mitigate these harms [Full text](https://drive.google.com/file/d/1SyV_tjNlYRHoM-KV1CS2onF5jGhot_F3/view){: class="button ilabel pink-block" target="_blank"}
